...
public class MyListAdapter extends BaseAdapter{
    ...
    public MyListAdapter(Fragment fragmet) {
        this.fragmet = fragmet;
    }

    @Override
    public int getCount() {
        return DataBase.myquests.size();
    }

    @Override
    public Object getItem(int i) {
        return DataBase.myquests.get(i);
    }
    ...
    public View getView(int i, View view, ViewGroup viewGroup) {
        ...
        ((TextView)view.findViewById(R.id.title_by_user)).setText(DataBase.myquests.get(i).title);
        //Log.d("MESSAGE", (String) ((TextView)view.findViewById(R.id.title_by_user)).getText());
        ((TextView)view.findViewById(R.id.description_by_user)).setText(DataBase.myquests.get(i).description);
